...
def main():
    ...
    # radius/max_nn tuned for a dense cloud with ~0.0053 avg point spacing
    # (check_scale.py suggested ~0.037; adjust if your data's scale differs).
    print("\nEstimating normals...")
    pcd.estimate_normals(
        search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=0.037, max_nn=50)
    )
